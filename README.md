...
6.3.1: 
The function should return, in our case, a boolean of True or False. If it is True then we know that a given year with that specific roll call number is a party line vote if the function returns True otherwise, it returns False. 

6.3.2: The vote on the Affordable Care act was a party line vote as in 2010, the year it was passed. We searched on the website provided in the project and tested all of the roll call numbers that were associated with this act and all of them proved that this was a party line vote. (111th Congress roll call number: 165,163,162,160,159) 
...
IV. Group note: 
As always, me and Huy worked on very good terms on this project. Learning from the past mistakes in the last two projects, we managed to communicate really well with no misunderstandings and managed to resolve the issues we encountered. 
V. Conclusion: 
